...
class TestExpenses():
        ...
        metadata = {
            ...
            "answers":{
                ...
                CATALOG_EMPLEADOS_OBJ_ID:{ #catalogo de empleados
                    "6092c0ebd8b748522446af26":"Leia Organa",
                    "6092c0ebd8b748522446af27":["Strategic Planning"],
                    "6092c0ebd8b748522446af28":["leia@starwars.com"]},
                CATALOG_MONEDA_OBJ_ID:{ #catalogo de monedas
                    "62aa1fa92c20405af671d123":"COP"},
                CATALOG_RESP_AUT_OBJ_ID:{ #catalogo de autorizadores
                    "62bf232626827cd253f9db16":"Yoda",
                    "62bf232626827cd253f9db17":["yoda@starwars.com"]},
                "61041b50d9ee55ab14965000":"cabuyaro",
                "61041b50d9ee55ab14965ba1":"instalacion",
                "61041b50d9ee55ab14965ba2":"2023-07-25",
                "61041b50d9ee55ab14965ba3":"2023-07-28",
                "61041b50d9ee55ab14965ba4":"bus",
                "61041b8370c14c09eff167ae":2000,
    ...
    def test_registros_de_gasto(self):
        ...
        for x in range(CANT_GASTOS):
            gasto = (x +1) * 100
            total += gasto
            res = self.create_registros_de_gasto(num='1', gasto=gasto, metodo="efectivo_-_debito")
            assert res['status_code'] == 201
        time.sleep(8)
        sol_catalog = self.search_catalogo_solicitud('1')
        print('sol', SOL)
        print('anticipo restante...',SOL['1']['monto_anticipo_restante'])
        print('anticipo_efectivo...',SOL['1']['anticipo_efectivo'])
        print('total...',total)
        assert SOL['1']['monto_anticipo_restante'] == SOL['1']['anticipo_efectivo'] - total
        assert SOL['1']['monto_restante'] == SOL['1']['monto_aprobado'] - total
        res_update = self.cerrar_solicitud(SOL['1']['folio'])
        autorizacion = self.search_autorizacion(SOL['1']['folio'])
        ...
        for rec in autorizacion:
            ...
            for gasto in gastos:
                ...
                desc += 1
            aut_ans['62954ccb8e54c96dc34995a5'] = 'autorizado_en_operaciones'
            # aut_ans['']
            # rec['_id'] = rec['id']
            print('\n\n\n\n\n')
    ...
    def create_registros_de_gasto(self, num='1', gasto=100, metodo="efectivo_-_debito"):
        global SOL
        metadata = {
            ...
            "answers":{
                ...
                CATALOG_MONEDA_OBJ_ID:{"62aa1fa92c20405af671d123":"COP"},
                "5893798cb43fdd4b53ab6e1e":metodo,
                ...
                "583d8e10b43fdd6a4887f55b":"2023-07-26",
                "610878f5bff8b3329fed6130":"cena",
                "62914e2d855e9abc32eabc16":"Purebas",
                "64cb3024b698f4b573a74248":"Establecimiento  - {}".format(gasto),
                },
                "folio":None,
                "properties":{
                    "device_properties":{"system":"Testing"},
    ...
    def cerrar_solicitud(self, folio):
        res_update = lkf_api.patch_multi_record(
            {'61041d15d9ee55ab14965bb6': 'en_autorizacion'}, 
    ...
    def search_autorizacion(self, folio):
        ...
        get_rec = self.get_record_from_db(FORM_AUTORIZACION_DE_VIATICOS, aut_folio)
        return get_rec
